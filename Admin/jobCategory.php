...
$du="SELECT * FROM tbl_jobcategory WHERE jobcategory_name='$jcategory'";
...
if($datas=mysqli_fetch_assoc($row1))
{
    echo json_encode(array("alert"=>"Existing"));
        ...
        $query="INSERT INTO tbl_jobcategory(jobcategory_name) VALUES ('$jcategory')";

        if(mysqli_query($con,$query))
        {
            $sel="SELECT * FROM tbl_jobcategory WHERE jobcategory_name='$jcategory'";
